...
Follow AGENTS.en.md and docs/hardware-design/AI_HARDWARE_DEVELOPMENT_GUIDE.en.md. Inspect relevant demo branches first,
...
- [`docs/INDEX.en.md`](INDEX.en.md) — complete documentation index for contribution, engineering, hardware, and software topics.
