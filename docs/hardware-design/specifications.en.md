...
This page defines user-facing specifications. Engineering details follow the [hardware guide](AI_HARDWARE_DEVELOPMENT_GUIDE.en.md) and `components/bsp/include/bsp_pins.h`.
