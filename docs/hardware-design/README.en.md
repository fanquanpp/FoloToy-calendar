...
- [AI_HARDWARE_DEVELOPMENT_GUIDE.en.md](AI_HARDWARE_DEVELOPMENT_GUIDE.en.md): complete board development and troubleshooting guide.
- [specifications.en.md](specifications.en.md): public device specifications.
